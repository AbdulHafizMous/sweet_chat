...
class CountryPickerUtils {
  ...
  static String getFlagImageAssetPath(String isoCode) {
    return "lib/biblio/countries/assets/${isoCode.toLowerCase()}.png";
  }
...
Widget buildDropdownItemForCountry(Country country) => SizedBox(
      width: double.maxFinite,
      child: Row(
        children: <Widget>[
          Expanded(flex: 0, child: CountryPickerUtils.getDefaultFlagImage(country)),
          const SizedBox(
            width: 10.0,
          ),
          Expanded(flex: 1,
            child: SingleChildScrollView(
              ...
              child: Text(" ${country.name}", style: wtTitle(18, 1, Colors.black, true, false),
...
Widget buildDropdownItemForPhNumber(Country country) => SizedBox(
      // width: 80,
      child: Text("+ (${country.phoneCode})", style: wtTitle(18, 1, Colors.black, true, false),),
    );